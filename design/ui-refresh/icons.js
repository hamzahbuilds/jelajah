...
// stroke 2, round caps/joins, currentColor). Injected once per page.
// Usage: <svg class="i"><use href="#i-home"/></svg>
(function () {
  const sprite = `
...
<g id="i-bag"><path d="M6 7.5 7.5 4h9L18 7.5"/><rect x="4" y="7.5" width="16" height="13" rx="2"/><path d="M9 11.5a3 3 0 0 0 6 0"/></g>
  ...
  // sprite is drawn on a 24px grid; <use> instances need the viewBox or the
  // paths render at natural size and spill out of the 16/20px boxes
  document.querySelectorAll('svg.i').forEach(s => s.setAttribute('viewBox', '0 0 24 24'));
})();
